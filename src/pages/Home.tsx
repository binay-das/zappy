...
const Home = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto min-h-screen w-full transition-colors duration-500">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-gray-300 hover:bg-gray-50 dark:hover:text-black px-8 py-6 text-lg rounded-xl"
              onClick={() => navigate("/text/code")}
            >
      ...
      <section className="container mx-auto px-4 py-16 lg:py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card
            className="border-0 cursor-pointer transition-shadow duration-300 shadow-md hover:shadow-dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.06)] 
          ...
          <Card
            className="border-0 cursor-pointer transition-shadow duration-300 shadow-md hover:shadow-xl dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.06)] 
              bg-gradient-to-br from-purple-50 to-purple-dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800"
          >
            <CardHeader>
          ...
          <Card className="border-0 cursor-pointer transition-shadow duration-300 shadow-md hover:shadow-xl dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.06)] 
            bg-gradient-to-br from-green-50 to-green-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800"
          >
            <CardHeader>
          ...
          <Card className="border-0 cursor-pointer transition-shadow duration-300 shadow-md hover:shadow-xl 
            dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.06)] bg-gradient-to-br from-orange-50 to-orange-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800"
          >
            <CardHeader>
          ...
          <Card
            className="border-0 cursor-pointer transition-shadow duration-300 shadow-md hover:shadow-xl dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.06)] 
              bg-gradient-to-br from-indigo-50 to-indigo-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800"
          >
            <CardHeader>
          ...
          <Card
            className="border-0 cursor-pointer transition-shadow duration-300 shadow-md hover:shadow-xl dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.06)] 
              bg-gradient-to-br from-pink-50 to-pink-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800"
          >
            <CardHeader>
      ...
      <section className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6 tex-gray-90">
            Three steps to{" "}
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-semibold mb-4">Write or Paste</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-semibold mb-4">Click Share</h3>
            <p className="text-gray-600 text-lg">
              Hit the share button and instantly get a unique code and shareable
              link.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-semibold mb-4">Share Anywhere</h3>
            <p className="text-gray-600 text-lg">
